...
class Aliyun
{
    ...
    public function __construct()
    {
        ...
        //读取配置
        $aliyunConfigArr=C('ALIDAYU_API_CONFIG');

        // 初始化用户Profile实例
        $profile = DefaultProfile::getProfile($region, $aliyunConfigArr['app_key'], $aliyunConfigArr['app_secret']);
    ...
    public function sendSms($templateCode, $phoneNumbers, $templateParam = null, $outId = null) {
        ...
        // 必填，设置签名名称
        $request->setSignName(C('ALIDAYU_API_CONFIG')['sign_name']);
