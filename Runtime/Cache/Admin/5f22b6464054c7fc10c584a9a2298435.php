...
<body class="mainbody">
    ...
    <div id="floatHead" class="toolbar-wrap">
        <div class="toolbar">
        	<div class="box-wrap">
                <a class="menu-btn"></a>
                <form action="<?php echo U('Admin/Goods/goodslist');?>" method="post" id="searchForm">
                    <div class="l-list">
                        <ul class="icon-list">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
            <tr>
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td onclick="editField(this,'goods','id','goods_title','<?php echo ($item["id"]); ?>',pajax_url,1,'<?php echo ($item["goods_title"]); ?>',0)"><?php echo ($item["goods_title"]); ?></td>
                        ...
                        <td align="center">
                            <a href="<?php echo U('Admin/Goods/edit',array('id' => $item['id']));?>">编辑</a>
                            <a href="<?php echo U('Mobile/Goods/detail',array('id' => $item['id']));?>">详情</a>
                        </td>
