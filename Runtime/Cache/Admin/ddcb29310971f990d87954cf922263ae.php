...
<head>
    ...
    <script type="text/javascript">
        //菜单获取
        var ajax_category="<?php echo U('Admin/Ajax/buildGoodsCategoryCache');?>";
        //单击修改的ajax地址
...
<div id="floatHead" class="toolbar-wrap">
    <div class="toolbar">
        <div class="box-wrap">
            ...
            <div class="l-list">
                <ul class="icon-list">
                    <li><a href="<?php echo U('Admin/GoodsCategory/add');?>"><i class="iconfont icon-close"></i><span>新增</span></a></li>
            ...
            <div class="r-list">
                ...
                <form action="<?php echo U('Admin/GoodsCategory/index');?>" method="post" id="searchForm">
...
<!--列表-->
<form name="categoryForm" id="categoryForm" method="post" action="<?php echo U('GoodsCategory/del');?>" >
<div class="table-container">
    <div class="tree-list">
        <div class="thead">
            ...
            <div class="col col-2">是否导航显示</div>
            <div class="col col-3">手机端首页显示</div>
            <div class="col col-2">是否推荐</div>
            <div class="col col-2">是否热门</div>
        ...
        <ul class="llist">
            <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><li class="layer-<?php echo ($vo["count"]); ?>">
                    <div class="tbody">
                        ...
                        <div  class="col col-4" onclick="editField(this,'goods_category','id','name','<?php echo ($vo["id"]); ?>',pajax_url,0,'<?php echo ($vo["name"]); ?>',0)" class="focusSpan"><span ><?php echo ($vo["name"]); ?></span></div>
                    <div class="col index col-4">
                        <span onclick="editField(this,'goods_category','id','title','<?php echo ($vo["id"]); ?>',pajax_url,0,'<?php echo ($vo["title"]); ?>',0)" class="focusSpan"><?php echo ($vo["title"]); ?></span>
                    </div>
                    <div class="col col-2">
                        <span boolvalue="<?php echo ($vo["is_hidden"]); ?>" onclick="editFieldIs(this,'goods_category','id','is_hidden','<?php echo ($vo["id"]); ?>',pajax_url,0,1)"><?php if(($item["is_hidden"] == 1)): ?>是<?php else: ?>否<?php endif; ?></span>
                    </div>
                    <div class="col col-2">
                        <span boolvalue="<?php echo ($vo["is_nav"]); ?>" onclick="editFieldIs(this,'goods_category','id','is_nav','<?php echo ($vo["id"]); ?>',pajax_url,0,1)"><?php if(($vo["is_nav"] == 1)): ?>是<?php else: ?>否<?php endif; ?></span>
                    </div>
                    <div class="col col-3">
                        <span boolvalue="<?php echo ($vo["is_index"]); ?>" onclick="editFieldIs(this,'goods_category','id','is_index','<?php echo ($vo["id"]); ?>',pajax_url,0,1)"><?php if(($vo["is_index"] == 1)): ?>是<?php else: ?>否<?php endif; ?></span>
                    </div>
                    <div class="col col-2">
                        <span boolvalue="<?php echo ($vo["rec"]); ?>" onclick="editFieldIs(this,'goods_category','id','rec','<?php echo ($vo["id"]); ?>',pajax_url,0,1)"><?php if(($vo["rec"] == 1)): ?>是<?php else: ?>否<?php endif; ?></span>
                    </div>
                    <div class="col col-2">
                        <span boolvalue="<?php echo ($vo["hot"]); ?>" onclick="editFieldIs(this,'goods_category','id','hot','<?php echo ($vo["id"]); ?>',pajax_url,0,1)"><?php if(($vo["hot"] == 1)): ?>是<?php else: ?>否<?php endif; ?></span>
                    </div>
                    <div class="col col-2">
                        <span onclick="editField(this,'goods_category','id','sort_num','<?php echo ($vo["id"]); ?>',pajax_url,0,'<?php echo ($vo["sort_num"]); ?>',0)" class="focusSpan"><?php echo ($vo["sort_num"]); ?></span>
                    </div>
                    <div class="col col-4" style="text-align: center;">
                        <a href="<?php echo U('GoodsCategory/add');?>?action=add&id=<?php echo ($vo["id"]); ?>">添加子级</a>
                        &nbsp;|&nbsp;
                        <a href="<?php echo U('GoodsCategory/add');?>?action=edit&id=<?php echo ($vo["id"]); ?>">修改</a>
                    </div>
                    </div>
