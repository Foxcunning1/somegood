            ...
            <a href="<?php echo U('Mobile/Goods/detail',array('id'=>$vo['id']));?>">
                ...
                <div class="g-info">
                    ...
                    <div class="location-and-time">
                        ...
                        <span class="time fr">总销量:<?php echo ($vo["total_sales_volume"]); ?></span>
                    </div>
                </div>
            </a>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $(".orderBtn").on("touchstart",function(){
            ...
            var jumpUrl = "<?php echo U('Mobile/Goods/list');?>?catid=<?php echo ($catid); ?>&order="+orderType;
            if($(this).hasClass("price")){
                if(orderType=="3"){
                    jumpUrl = "<?php echo U('Mobile/Goods/list');?>?catid=<?php echo ($catid); ?>&order=2";
                }else{
                    jumpUrl = "<?php echo U('Mobile/Goods/list');?>?catid=<?php echo ($catid); ?>&order=3";
                }
            }
        ...
        $("#submitBtn").on("touchstart",function(){
            ...
            if(catid!=""){
                jumpUrl = "<?php echo U('Mobile/Goods/list');?>?catid="+catid+"&order=<?php echo ($order); ?>";
                window.location.href = jumpUrl;
            }
        })
        /*筛选取消*/
    ...
    var ajaxUrl="<?php echo U('Mobile/Goods/list');?>?catid=<?php echo ($catid); ?>&order=<?php echo ($order); ?>&isajax=1";//ajax请求地址
    $(function(){
