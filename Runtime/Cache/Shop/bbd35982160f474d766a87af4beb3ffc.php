    ...
    <div class="w1200">
        ...
        <div class="right-show fr">
            ...
            <div class="u-tab-head">
                <p>
                    <?php $_result=C('FRONT_ORDER_STATUS_LIST');if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><a href="<?php echo U('UserOrder/orderlist',array('status' => $key));?>" <?php if($status == $key): ?>class="selected"<?php endif; ?> ><?php echo ($item); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
                </p>
            </div>
            <div class="u-tab-content">
                <?php if(empty($list)): ?><p style="text-align:center;">暂无订单！</p>
                    <?php else: ?>
                    <table class="shop-order-table">
                        ...
                        <!--订单-->
                        <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($k % 2 );++$k;?><tbody>
                            <tr class="sep-row">
                                <td colspan="5"></td>
                            </tr>
                            <tr class="tr-th">
                                <td colspan="5">
                                    ...
                                    <span class="number">
    								订单号：<a href="javascript:;"><?php echo ($item["order_sn"]); ?></a>
    							</span>
                                </td>
                            </tr>
                            <tr class="tr-bd">
                                <td>
                                    <div class="goods-item p-3235700">
                                        <div class="p-img"><a href="javascript:;"><img src="/somegood/Public/uploads/<?php echo ($item["tb"]); ?>_c200x200" alt="商品图" /></a></div>
                                        <div class="p-msg">
                                            <div class="p-name"><?php echo ($item["goods_title"]); ?></div>
                                        </div>
                                        <div class="goods-number">X<?php echo ($item["counts"]); ?></div>
                                    </div>
                                </td>
                                <td rowspan="1">
                                    <div class="consignee tooltip">
                                        <span class="txt"><?php echo ($item["consignee"]); ?></span>
                                    </div>
                                </td>
                                <td rowspan="1">
                                    <div class="amount">
                                        <span>总额 ¥<?php echo ($item["money"]); ?></span>
                                    </div>
                                </td>
                                <td rowspan="1">
                                    <div class="status">
                                        <!--订单的三个状态-->
                                        <!--1-->
                                        <span class="order-status ftx-01">
                                            <?php if($item['status'] == 0): ?>待付款
                                            <?php elseif($item['status'] == 1): ?>待发货
                                            <?php elseif($item['status'] == 2): ?>待收货
                                        ...
                                        <br/>
                                        <a href="<?php echo U('Shop/UserOrder/detail',array('order_sn'=>$item['order_sn']));?>">订单详情</a>
                                    </div>
                                </td>
                                <td rowspan="1">
                ...
                <div class="page-foot">
                    <div class="flickr right"><?php echo ($page); ?></div>
                </div>
            </div>
            <input id="turl" value="<?php echo U('UserOrder/orderlist',array('status'=>$status));?>" type="hidden"><!--存在跳转的URL值-->
            <!--/系统消息-->
        </div>
        <div class="clear"></div>
    </div>
