...
<body>
   ...
   <form action="<?php echo U('Shop/Order/addUserAddress');?>" name="form1" id="newAddressForm" method="post"  onsubmit="return saveReport()">
       ...
       $(".edit-btn").on('click', function(event) {
           ...
           */
           $.ajax({
                           cache: true,
                           type: "POST",
                           url:"<?php echo U('Shop/Order/addUserAddress');?>",
