		...
		<div class="w1200">
			...
			<div class="right-show fr">
			      <div class="u-tab-head">
					  <p>
						  <a class="selected" href="<?php echo U('Shop/Users/contact',array('type'=>'email'));?>">更换邮箱</a>
						  <a href="<?php echo U('Shop/Users/contact',array('type'=>'mobile'));?>">更换手机</a>
					  </p>
			      </div>
			      <div class="u-tab-content">
			        <div class="title-div">
			          <strong>更换邮箱</strong>
				        ...
				        <form url="<?php echo U('Shop/Users/email');?>" id="emailForm" name="emailForm">
				        <div class="form-box">
				          <dl>
				            <dt>已绑定邮箱：</dt>
							...
							<dl>
								...
								<dd>
									<select name="data[codeType]" id="codeType" class="select" datatype="*" sucmsg=" " style="float:left;">
										...
										<?php if($info['mobile'] != ''): ?><option value="1">手机</option>
											<input type="hidden" name="data[mobile]" value="<?php echo ($info['mobile']); ?>"><?php endif; ?>
				          ...
				          <dl>
				            <dt>新邮箱：</dt>
				            <dd>
				              <input name="data[email]" id="txtEmail" type="text" class="input txt" style="float:left" datatype="e" ajaxurl="<?php echo U('Shop/Login/checkEmail');?>" nullmsg="请输入新的邮箱" errormsg="邮箱不能为空" sucmsg=" " />
				              <input type="button" class="bBtn" value="获取绑定验证码" style="margin-top: -3px;"/>
								<input type="hidden" name="data[old_email]" value="<?php echo ($info["email"]); ?>">
				            </dd>
				          </dl>
				          <dl>
				            <dt>绑定验证码：</dt>
				          ...
				          <dl>
				            ...
				            <dd>
				              ...
				              <input type="hidden" id="tUrl" name="tUrl" value="<?php echo U('Shop/Users/email');?>" />
				            </dd>
				          </dl>
				        </div>
				        </form>
