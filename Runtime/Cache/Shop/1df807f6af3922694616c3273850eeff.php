		...
		<div class="right-show fr">
			...
			<div class="u-tab-head">
				<p style="line-height: 40px;">
					<a href="<?php echo U('Shop/Users/coupon',array('pageType' => 'can_use'));?>" <?php if($pageType == 'can_use'): ?>class="selected"<?php endif; ?> >优惠券</a>
					<a href="<?php echo U('Shop/Users/coupon',array('pageType' => 'used'));?>" <?php if($pageType == 'used'): ?>class="selected"<?php endif; ?> >已使用</a>
					&nbsp;&nbsp;&nbsp;&nbsp;您当前可使用的优惠券总金额为：<b style="color:#f00;"><?php echo ($sum); ?></b>元
				</p>
			</div>
			<div class="u-tab-content">
				<div class="title-div">
					<strong>
						<?php if(($type == 0) OR ($type == '')): ?>优惠券来源明细
						<?php else: ?>
						抵扣明细<?php endif; ?>
					</strong>
				</div>
				<?php if(($pageType) == "can_use"): ?><table class="mtable" border="0" cellpadding="0" cellspacing="0" width="100%">
					<tbody>
					<tr>
					...
					<?php if(empty($list)): ?><tr><td colspan="5" align="center">亲，您还没有可用的优惠券！</td></tr><?php endif; ?>
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
								<td align="center"><?php echo ($item["coupon_id"]); ?></td>
								<td align="center"><?php echo ($item["type_name"]); ?></td>
								<td align="left">
									<?php if(($item["is_all"]) == "1"): ?>全场通用
										<?php else: ?>
										<?php echo ($item["goods_category"]); endif; ?>
								</td>
								<td align="center"><?php echo (date('Y-m-d H:i:s',$item["use_start_date"])); ?>--<?php echo (date('Y-m-d H:i:s',$item["use_end_date"])); ?></td>
				...
				<table class="mtable" border="0" cellpadding="0" cellspacing="0" width="100%">
					...
					<tr>
						...
						<th align="center">抵扣时间</th>
					</tr>
					<?php if(empty($list)): ?><tr><td colspan="5" align="center">亲，您还没有抵扣记录！</td></tr><?php endif; ?>
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
								<td align="center"><?php echo ($item["coupon_id"]); ?></td>
								<td align="center"><?php echo ($item["type_name"]); ?></td>
								<td align="center"><?php echo ($item["order_sn"]); ?></td>
								<td align="center"><?php echo (date('Y-m-d H:i:s',$item["used_time"])); ?></td>
							</tr><?php endforeach; endif; else: echo "" ;endif; ?>
					</tbody>
				</table><?php endif; ?>
