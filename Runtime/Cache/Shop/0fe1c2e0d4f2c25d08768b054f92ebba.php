		...
		<div class="w1200">
			...
			<div class="right-show fr">
			      <div class="u-tab-head">
			        <p>
			          <a href="<?php echo U('Shop/Users/setting',array('action'=>'info'));?>">个人资料</a>
			          <a class="selected" href="<?php echo U('Shop/Users/password');?>">修改密码</a>
			        </p>
			      </div>
			      <div class="u-tab-content">
			        ...
			        <form url="<?php echo U('Shop/Users/password');?>" id="pwdForm" name="pwdForm">
			        <div class="form-box">
			          <dl>
			            <dt>用户名：</dt>
			            <dd><?php echo ($_SESSION['shop']['username']); ?></dd>
			          </dl>
			          <dl>
			            <dt>旧密码：</dt>
			            <dd>
			              <input name="oldPassword" id="txtOldPassword" type="password" class="input txt" datatype="*6-20" ajaxurl="<?php echo U('Shop/Users/ajax');?>" nullmsg="请输入旧密码" errormsg="密码范围在6-20位之间" sucmsg=" " />
			            </dd>
			          </dl>
			          <dl>
			            <dt>新密码：</dt>
			            <dd>
			              <input name="password" id="txtPassword" type="password" class="input txt" datatype="*6-20" nullmsg="请输入新密码" errormsg="密码范围在6-20位之间" sucmsg=" " />
			            </dd>
			          </dl>
			          <dl>
			            <dt>确认新密码：</dt>
			            <dd>
			              <input name="password1" id="txtPassword1" type="password" class="input txt" datatype="*" recheck="password" nullmsg="请再输入一次新密码" errormsg="两次输入的密码不一致" sucmsg=" " />
			            </dd>
			          </dl>
			          <dl>
			            <dt></dt>
			            <dd>
			              ...
			              <input type="hidden" id="tUrl" name="tUrl" value="<?php echo U('Shop/Login/loginOut');?>" />
			            </dd>
			          </dl>
			        </div>
			        </form>
