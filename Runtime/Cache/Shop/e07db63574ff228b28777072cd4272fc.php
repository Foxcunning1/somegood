...
<div class="header">
		...
		<div class="w1200">
			...
			<div class="right-show fr">
			      ...
			      <div class="u-tab-head">
			        <p>
						<a <?php if(($status == 0) OR ($status == '')): ?>class="selected"<?php endif; ?> href="<?php echo U('Shop/Users/favorites');?>">商品收藏</a>
						<!--<a <?php if($status == 2): ?>class="selected"<?php endif; ?> href="<?php echo U('Shop/Users/favorites',array('status'=>2));?>">店铺收藏</a>-->
					</p>
			      </div>
			          ...
			          <!--取得一个DataTable-->
			           <!--取得分页页码列表-->
			            <tbody>
			                ...
			                <?php if(empty($list)): ?><tr><td colspan="4">暂无消息！</td></tr>
			                <?php else: ?>
			                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
				              <td align="center" width="30"><input name="checkId" class="checkall" value="<?php echo ($item["favorite_id"]); ?>" type="checkbox"></td>
				              <td>
				                 <div class="proInfo">
					                 <a href="<?php echo U('Shop/Goods/goods',array('id'=>$item['favorite_id']));?>" target="_blank">
					                 	<img width="60" height="60" src="/somegood/Public/Uploads/<?php echo ($item["goods_thumb"]); ?>" alt="<?php echo ($item["title"]); ?>" >
					                 </a>
					                 <dl>
					                 	<dt><a href="<?php echo U('Shop/Goods/goods',array('id'=>$item['favorite_id']));?>" target="_blank"><?php echo (mb_substr($item["title"],0,20,'UTF-8')); ?></a></dt>
					                 	<dd>价格：<b class="price"><?php echo ($item["price"]); ?></b> 元</dd>
					                 </dl>
				                 </div>
				              </td>
				              <td align="center"><?php echo (date('Y-m-d',$item["add_time"])); ?></td>
				              <td align="center" width="100"><a onclick="ExecPostBack('<?php echo ($item["favorite_id"]); ?>');" href="javascript:void(0);">删除</a></td>
			      ...
			      <input id="turl" value="<?php echo U('Shop/Users/favorites');?>" type="hidden"><!--存在跳转的URL值-->
			      <!--/留言消息-->
			</div>
		</div>
	</div>
	...
	function ExecPostBack(checkValue) {
	    var sendUrl = "<?php echo U('Shop/Users/delFavorites');?>";
		if (arguments.length == 1) {
			ExecDelete("<?php echo U('Shop/Users/delFavorites');?>", checkValue, '#turl');
		}else{
			var valueArr = '';
			...
			ExecDelete("<?php echo U('Shop/Users/delFavorites');?>", valueArr, '#turl');
		}
