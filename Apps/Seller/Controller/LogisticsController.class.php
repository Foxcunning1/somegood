...
class LogisticsController extends BaseController{
    ...
    public function indexAction(){
        ...
        $pageNum=I('p',1);
        $condition['users_id']=session('seller.id');
    ...
    public function addLogisticsAction(){
        $data=I('data');
        $data['users_id']=session('seller.id');
    ...
    public function startAction(){
        ...
        $re=$SellerLogistics->where(array('id'=>$id,'users_id'=>session('seller.id')))->setField($save);
        if ($re!==false){
    ...
    */
    public function listAction(){
        $id=I('id');
        $pageNum=I('p',1);
        $condition['seller_logistics_id']=$id;
        $SellerLogistics=D('Common/SellerLogistics');
    ...
    */
    ...
    public function editRemarksAction(){
        ...
        $re=M('seller_logistics')->where(array('id'=>$id))->save($data);
        if ($re!==false){
