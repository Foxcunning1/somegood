 ...
 * @Param        obj             me                       对象
 * @Param        obj             tabLoadName              加载事件
 * @Param        url             detailUrl                一手/二手详情地址
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $.each(data.data.list,function(index, vo) {
                    ...
                    switch (showType){
                        case 0:
                            str+="<li id='favorite_0_"+vo['favorite_id']+"'>";
                            break;
                        case 1:
                            str+="<li id='favorite_1_"+vo['favorite_id']+"'>";
                            break;
                    }
                    str+="<div class=\"g-img\"><a href=\""+detailUrl+"?id="+vo['favorite_id']+"\"><img src=\""+imgPath+"statics/mobile/images/default_img.png\" data-original=\""+imgPath+"uploads/"+vo['goods_thumb']+"_c200x200\" alt=\"\"></a></div>";
                    str+="<div class=\"g-info\">";
                    str+="<div class=\"product-name\">";
                    str+="<a href=\""+detailUrl+"?id="+vo['favorite_id']+"\">"+vo['title']+"</a>";
                    str+="</div>";
                    str+="<div class=\"product-price-m\">";
                    str+="<em>¥<span class=\"big-price\">"+vo['price']+"</span></em>";
                    str+="</div>";
                    str+="<div class=\"location-and-time\">";
                    switch (showType){
                        case 0:
                            str+="<a href=\"javascriot:void(0);\"  onclick='cancelFavorite("+vo['favorite_id']+",0);'class=\"collection-cancel fr\"><i class=\"icons icon-like-yet fl\"></i><span class=\"fr\">取消收藏</span></a>";
                            break;
                        case 1:
                            str+="<a href=\"javascriot:void(0);\"  onclick='cancelFavorite("+vo['favorite_id']+",1);'class=\"collection-cancel fr\"><i class=\"icons icon-like-yet fl\"></i><span class=\"fr\">取消收藏</span></a>";
                            break;
                    }
                    str+="</div>";
                    str+="</div>";
