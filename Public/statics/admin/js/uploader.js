...
$(function () {
    ...
    $.fn.InitUploader = function (b) {
        var fun = function (parentObj) {
            ...
            if(p.modeltype){
                p.sendurl += "&modeltype=" + p.modeltype;
            }
            //初始化WebUploader
            ...
            uploader.on('uploadSuccess', function (file, data) {
                ...
                if (data.status == '1') {
                    ...
                    if (!p.multiple) {
                        ...
                        addImage(parentObj, data.path, data.path+"_c120x120",data.upfile);
                    }
                    var progressObj = parentObj.children(".upload-progress");
...
function setRemark(obj) {
    ...
    var hidRemarkObj = parentObj.prevAll("input[name='rphoto[]']").eq(0); //取得隐藏值
    var d = parent.dialog({
        title: "图片描述",
        ...
        button: [{
            ...
            callback: function () {
                ...
                parentObj.parent().parent().find("li input[name='rphoto[]']").val(remarkObj.val());
